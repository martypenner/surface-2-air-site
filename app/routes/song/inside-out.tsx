  ...
  return (
    <>
      ...
      <p>
        ...
        <br />I can see your eyes are screaming the sound your mouth won't make,
        <br />
        ...
        <br />
        You're still hanging on to the fear of purchasing freedom; it's so
        relieving. But the price tag turns your eyes away.
        <br />
        <br />
