  ...
  return (
    <>
      ...
      <p>
        ...
        <br />
        <br />I wanted it to pass away;
        <br />
        knowing that blood would be dripping down My side.
        <br />I wanted it to fade away.
        <br />
        ...
        <br />I hear you crying out for something more;
        <br />
        ...
        <br />
        <br />I drank from the cup anyway, so you wouldn't have to feel lonely
        tonight.
      </p>
    </>
  );
