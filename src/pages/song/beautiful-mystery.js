...
const BeautifulMystery = () => {
  return (
    <Layout title="Beautiful Mystery">
      <h3>
        <strong>Beautiful Mystery</strong>
      </h3>
      <br />
      <p>
        I’m amazed at Your wondrous ways.
        <br />I can’t explain or understand.
        <br />
        ...
        <br />
        <br />
        &nbsp;&nbsp;&nbsp; I know we’ll never fully understand You while we’re
        here.
        <br />
        ...
        <br />
        &nbsp;&nbsp;&nbsp; One day we’ll see You face to face and it’ll all
        become clear to me.
        <br />
        <br />
        You’re a beautiful mystery, to me.
        <br />
        You’re a beautiful mystery, to me. <br />
        <br />
        ...
        <br />
        <br />
        &nbsp;&nbsp;&nbsp; I hold this mystery inside of my heart. <br />
...
export default BeautifulMystery
