...
const Broken = () => {
  return (
    <Layout>
      ...
      <br />
      <p>
        I'm in that place again I couldn't soon forget the pain I felt that
        night.
        <br />
        Taken away my life there's nothing left inside, please still my beating
        heart tonight.
        <br />
        <br />
        I'm every thing I hate, I failed to be what I need.
        <br />
        <br />I hate my life...no more to hide.
        <br />
        It makes me sick, as I live through it, prepare to die.
        <br />
        <br />I lie in the bed I made, bury me far away, no more I need the air
        I breath.
        <br />
        ...
        <br />
        <br />I don't want to feel this pain inside...NOW I KNOW
        <br />
